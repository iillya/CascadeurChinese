...
if not exist "%ROOT%\build\hotkey-test" mkdir "%ROOT%\build\hotkey-test"
cl /nologo /EHsc /std:c++17 /Zc:__cplusplus /permissive- /O2 /W4 /WX /utf-8 /MD /DQT_NO_DEBUG /DQT_GUI_LIB ^
 /external:I"%QT%\include" /external:W0 "%ROOT%\source\analysis\hotkey_settings_test.cpp" ^
 /Fo"%ROOT%\build\hotkey-test\test.obj" /Fe"%ROOT%\build\hotkey-test\test.exe" ^
